...
final class AutomationService
{
    ...
    public function run(): array
    {
        ...
        $summary['message'] = sprintf(
            'Automation finished. order_created=%d order_linked=%d order_skipped=%d already_synced=%d unmapped=%d requires_review=%d previously_ignored=%d jtl_unreachable=%d order_failed=%d fulfillment_failed=%d.',
            ...
            (int) ($summary['orders']['requires_review'] ?? 0),
