        ...
        return [
            ...
            [
                ...
                'fields' => [
                    ...
                    self::text('JTL_WORKERS_ENDPOINT', 'Workers endpoint', '/api/eazybusiness/workers'),
                    ...
                    self::textarea('JTL_MANDATORY_API_SCOPES', 'Scopes obligatorios', 'salesorders.read,salesorders.write,items.read,items.write,item.queryitems,item.createitem,item.updateitem,inventories.read,inventories.write,stock.querystocksperitem,stock.stockadjustment,deliverynotes.read,deliverynotes.write,worker.getworkersyncs,system.worker.read'),
