        ...
        return [
            ...
            [
                ...
                'fields' => [
                    ...
                    self::boolean('AUTOMATION_ENABLED', 'Automatizacion activa', true),
                    self::number('AUTOMATION_INTERVAL_MINUTES', 'Intervalo automatico en minutos', '360'),
            ...
            [
                ...
                'fields' => [
                    ...
                    self::boolean('JTL_AUTO_CREATE_DELIVERY_NOTE', 'Auto crear delivery note si falta', false),
                    ...
                    self::text('JTL_WORKERS_ENDPOINT', 'Worker list endpoint (diagnostico)', '/api/eazybusiness/v1/workers'),
                    self::text('JTL_WORKER_STATUS_ENDPOINT', 'Worker status endpoint (diagnostico)', '/api/eazybusiness/v1/workers/status'),
                    self::boolean('JTL_WORKER_DISCOVERY_ENABLED', 'Leer Worker por API', false),
            ...
            [
                ...
                'fields' => [
                    ...
                    self::text('PACKIYO_ORDER_CREATED_FROM_FILTER', 'Filtro API fecha desde', 'filter[created_at_min]'),
                    self::text('PACKIYO_ORDER_CREATED_TO_FILTER', 'Filtro API fecha hasta', 'filter[created_at_max]'),
