...
La tabla permite seleccionar ordenes editables de forma individual. La previsualizacion seleccionada incluye automaticamente todas las lineas `JTL-LINE-*` de cada orden; despues se pueden corregir solo esas ordenes en Packiyo. Una ejecucion vacia se rechaza y cada lote admite como maximo diez ordenes, por lo que se puede probar primero con una sola y ampliar el lote despues de verificarla.
