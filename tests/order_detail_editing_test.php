...
assertContainsText('>Guardar</button>', $editableHtml, 'Una orden pendiente debe mostrar el control para guardar.');
...
assertContainsText('>Guardar</button>', $sentHtml, 'Una orden enviada debe mostrar controles de guardado local.');
