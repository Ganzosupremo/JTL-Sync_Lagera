...
return [
    ...
    'workers_endpoint' => Setting::get('JTL_WORKERS_ENDPOINT', '/api/eazybusiness/v2/workers'),
    'worker_endpoint' => Setting::get('JTL_WORKER_ENDPOINT', '/api/eazybusiness/v2/workers/control'),
    'worker_status_endpoint' => Setting::get('JTL_WORKER_STATUS_ENDPOINT', '/api/eazybusiness/v2/workers/status'),
    ...
    'worker_sync_body_template' => Setting::get('JTL_WORKER_SYNC_BODY_TEMPLATE', '{"syncId":"{{sync_id}}","action":0}'),
